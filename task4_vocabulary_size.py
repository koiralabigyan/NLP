...
# Convert emoji tags to actual emojis
...
vocab_before = set(all_tokens)

# After preprocessing
all_cleaned_tokens = [word for review_tokens in [tokenize_remove_stopwords(clean_text(r)) for r in reviews] for word in review_tokens]
vocab_after = set(all_cleaned_tokens)
